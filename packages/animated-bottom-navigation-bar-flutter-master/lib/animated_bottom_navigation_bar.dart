...
class AnimatedBottomNavigationBar extends StatefulWidget {
  ...
  final List<TextStyle>? titleTextStyle;
  ...
  AnimatedBottomNavigationBar({
    ...
    required List<String> titleText,
    required List<TextStyle> titleTextStyle,
    ...
    for (var i = 0; i < itemCount; i++) {
      ...
      items.add(
        NavigationBarItem(
          ...
          titleText: widget.titleText?.elementAt(i),
          titleTextStyle:widget.titleTextStyle?.elementAt(i) ,
