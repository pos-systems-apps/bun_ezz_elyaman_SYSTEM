        ...
        return Expanded(
          child: Container(
            ...
            child: SingleChildScrollView(
              child: PrintResourcesInvoicesCubit.get(context).invoiceResponseModel == null
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        MoneyWidget1(
                            text: "اسم المندوب",
                            value: PrintResourcesInvoicesCubit.get(context)
                                .invoiceResponseModel!
                                .invoice
                                .seller
                                .name),
                        ...
                        MoneyWidget1(
                            ...
                            value: getIt<AppConstant>()
                                .pays[PrintResourcesInvoicesCubit.get(context)
                                        .invoiceResponseModel!
                                        .invoice
                                        .paymentType -
                                    1]
                        ...
                        MoneyWidget3(
                            ...
                            value:
                                "${AppConstant.currency} ${PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.orderAmount + PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.productsDiscount + PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.extraDiscount}"),
                        verticalSpace(8),
                        MoneyWidget3(
                            text: "خصم المنتج",
                            value:
                                "${AppConstant.currency} ${PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.productsDiscount}"),
                        verticalSpace(8),
                        MoneyWidget3(
                            text: "خصم اضافي",
                            value:
                                "${AppConstant.currency} ${PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.extraDiscount}"),
                        verticalSpace(8),
                        MoneyWidget3(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                                "${AppConstant.currency} ${PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.orderAmount}",
                                style: TextStyles.font12greyColor33Weight600),
                          ],
                        ),
                        verticalSpace(24),

                        if (PrintResourcesInvoicesCubit.get(context)
                                .invoiceResponseModel!
                                .invoice
                                .type ==
                            "4")
                          MoneyWidget3(
                              text: "المبلغ المدفوع",
                              value:
                                  "${AppConstant.currency} ${PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.collectedCash}"),
                        if (PrintResourcesInvoicesCubit.get(context)
                                .invoiceResponseModel!
                                .invoice
                                .type ==
                        ...
                        if (PrintResourcesInvoicesCubit.get(context)
                          ...
                          MoneyWidget3(
                              text: "المبلغ المتبقي",
                              value:
                                  "${AppConstant.currency} ${(PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.orderAmount + PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.productsDiscount + PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.extraDiscount) - PrintResourcesInvoicesCubit.get(context).invoiceResponseModel!.invoice.collectedCash}"),
