...
import 'package:pos_system/features/create_visit/data/services/create_visit_api_end_points.dart';
import 'package:pos_system/features/transfer_section/data/services/transfer_section_api_end_points.dart';
...
class TransferSectionService {
  ...
  Future<SuccessResponseModel> createVisit(
    ...
    final response = await apiConsumer.post(
        TransferSectionApiEndPoints.createVisitURl,
        CreateVisitRequest(
