...
class TransferSectionMoneyTextFieldWidget extends StatelessWidget {
  const TransferSectionMoneyTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: TransferSectionCubit.get(context).moneyController,
      prefixIcon: Padding(
