...
class TransferSectionAccountTextFieldWidget extends StatelessWidget {
  const TransferSectionAccountTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: TransferSectionCubit.get(context).accountController,
      prefixIcon: Padding(
