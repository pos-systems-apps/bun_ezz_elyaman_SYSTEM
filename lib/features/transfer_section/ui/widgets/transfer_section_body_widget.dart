...
import 'package:pos_system/features/transfer_section/ui/widgets/transfer_section_account_text_field_widget.dart';
import 'package:pos_system/features/transfer_section/ui/widgets/transfer_section_money_text_field_widget.dart';
import 'package:pos_system/features/transfer_section/ui/widgets/transfers_notes_text_field_widget.dart';
import 'package:pos_system/features/transfer_section/ui/widgets/transfers_upload_image_widget.dart';
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          TransferSectionAccountTextFieldWidget(),
          verticalSpace(16),
          TransferSectionMoneyTextFieldWidget(),
          verticalSpace(16),
          TransfersUploadImageWidget(),
          verticalSpace(36),
          TransfersNotesTextFieldWidget(),
          verticalSpace(36),
          Row(
            children: [
              Expanded(
              ...
              horizontalSpace(20),
              BlocConsumer<TransferSectionCubit, TransferSectionState>(
