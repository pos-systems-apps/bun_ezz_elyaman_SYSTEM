...
class TransfersNotesTextFieldWidget extends StatelessWidget {
  const TransfersNotesTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: TransferSectionCubit.get(context).noteController,
