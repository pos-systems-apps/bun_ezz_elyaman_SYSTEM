...
class AddTransferSectionMoneyTextFieldWidget extends StatelessWidget {
  const AddTransferSectionMoneyTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddTransferSectionCubit.get(context).moneyController,
      prefixIcon: Padding(
        padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
        child: SvgPicture.asset(ImageAsset.icon13),
      ),
