...
class AddTransfersNotesTextFieldWidget extends StatelessWidget {
  const AddTransfersNotesTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddTransferSectionCubit.get(context).noteController,
