...
class AddTransferSectionAccountTextFieldWidget extends StatelessWidget {
  const AddTransferSectionAccountTextFieldWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return AppTextFormField(
      hintText: "اختيار الحساب",
      maxLines: 1,
      hintStyle: TextStyles.font14GreyColor87Weight400,
      textStyle: TextStyles.font14BlackColorWeight400,
      controller: AddTransferSectionCubit.get(context).accountController,
      prefixIcon: Padding(
        padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
        child: SvgPicture.asset(ImageAsset.icon12),
      ),
