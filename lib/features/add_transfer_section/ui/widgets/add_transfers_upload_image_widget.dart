...
class AddTransfersUploadImageWidget extends StatelessWidget {
  const AddTransfersUploadImageWidget({super.key});
    ...
    return BlocBuilder<AddTransferSectionCubit, AddTransferSectionState>(
      ...
      builder: (context, state) {
        return GestureDetector(
          onTap: () {
            AddTransferSectionCubit.get(context).uploadImage();
          },
          child: DottedBorder(
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: AddTransferSectionCubit.get(context).selectedImagePath ==
                        null
                    ? Column(
