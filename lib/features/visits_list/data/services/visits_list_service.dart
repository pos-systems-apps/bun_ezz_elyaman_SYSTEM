...
import 'package:pos_system/features/visits_list/data/services/visits_list_api_end_points.dart';

class VisitsListService {
  ApiConsumer apiConsumer;

  VisitsListService({required this.apiConsumer});

  Future<SuccessResponseModel> createVisit(
      CreateVisitRequest parameter) async {
    final response = await apiConsumer.post(
        VisitsListApiEndPoints.createVisitURl,
        CreateVisitRequest(
