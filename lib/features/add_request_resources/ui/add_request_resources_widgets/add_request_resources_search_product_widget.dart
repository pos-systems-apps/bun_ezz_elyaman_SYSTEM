...
class AddRequestResourcesSearchProductWidget extends StatelessWidget {

  const AddRequestResourcesSearchProductWidget({ super.key});
  ...
  Widget build(BuildContext context) {
    return SearchWidget(
      ...
      controller: AddRequestResourcesCubit.get(context).searchProductController,
      ...
      onchange: (String? value) {
        AddRequestResourcesCubit.get(context).getSearchProductsFromHere();
      },
    );
  }
}
