...
import 'package:pos_system/features/invoice/ui/widgets/invoice_shimmer_widget.dart';
        ...
        return Expanded(
          child: Container(
            ...
            child: SingleChildScrollView(
              child: InvoiceCubit.get(context).invoiceResponseModel == null
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        MoneyWidget1(
                            text: "اسم المندوب",
                            value: InvoiceCubit.get(context).invoiceResponseModel!.invoice.seller.name),
                        verticalSpace(8),
                        MoneyWidget1(text: "كود العربه", value: InvoiceCubit.get(context).invoiceResponseModel!.invoice.seller.vehicleCode),
                        verticalSpace(8),
                        MoneyWidget1(text: "كود المندوب", value: InvoiceCubit.get(context).invoiceResponseModel!.invoice.seller.mandoubeCode),
                        verticalSpace(8),
                        MoneyWidget1(text: "اسم العميل", value: InvoiceCubit.get(context).invoiceResponseModel!.invoice.customer.name),
                        verticalSpace(8),
                        MoneyWidget1(text: "طريقه الدفع", value: "00000000"),
                        verticalSpace(16),
                        ...
                        verticalSpace(8),
                        MoneyWidget3(
                            text: "ضريبه القيمه المضافه", value: "145 رس"),
                        verticalSpace(30),
                        Row(
