...
class ReseatUploadImageWidget extends StatelessWidget {
  const ReseatUploadImageWidget({super.key});
    ...
    return BlocBuilder<SalesCubit, SalesState>(
      ...
      builder: (context, state) {
        return GestureDetector(
          onTap: () {
            SalesCubit.get(context).uploadImage();
          },
          child: DottedBorder(
            ...
            child: ClipRRect(
              ...
              child: Container(
                ...
                child: SalesCubit.get(context).selectedImagePath == null
                    ? Column(
