...
class ProductSelectedWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController discountController = TextEditingController(
      text: selectedProduct.discountMoney.toString(),
    );

    final double availableQuantity = selectedProduct.product.availableQuantity;
    final double sellingPrice = selectedProduct.product.sellingPrice;
    final double discount = selectedProduct.product.discount;
    final String discountType = selectedProduct.product.discountType;

    final double priceAfterDiscount = discount == 0
        ? sellingPrice
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(4.r),
        border: Border.all(
          color: AppColors.greyColor82.withValues(alpha: .5),
        ),
      ),
      child: Column(
        children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        if (discount == 0)
                          Text(
                            "'جنيه' ${sellingPrice.toStringAsFixed(2)}",
                            style: TextStyles.font14GreyColor66Weight400,
                          ),
                        if (discount != 0) ...[
                          Text(
                          ...
                          horizontalSpace(4),
                          Text(
                            "'جنيه' ${priceAfterDiscount.toStringAsFixed(2)}",
                            style:
                            TextStyles.font14GreyColor66Weight400.copyWith(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "${availableQuantity.toStringAsFixed(2)} ${selectedProduct.product.unit?.symbol ?? ''}",
                      maxLines: 4,
                      style: TextStyles.font18greyColor27Weight600,
                    ),
                  ),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: AppTextFormField(
                    ...
                    validator: (String? value) {
                      ...
                      final double productTotal = quantity * priceAfterDiscount;
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "${selectedProduct.discountMoney.toStringAsFixed(2)} جنيه",
                      maxLines: 4,
                      style: TextStyles.font14GreyColor66Weight400.copyWith(
                        color: AppColors.greenColor,
                      ),
  ...
  void validateProductQuantityAndDiscount(
      BuildContext context,
      TextEditingController quantityController,
      TextEditingController discountController,
      GlobalKey<FormState> quantityKey,
      GlobalKey<FormState> discountKey,
      ) {
    if (quantityKey.currentState!.validate() &&
        discountKey.currentState!.validate()) {
      SalesCubit.get(context).editInProductFromSelectedProducts(
