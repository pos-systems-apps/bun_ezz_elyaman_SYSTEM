...
class CreateMonthlyPlanSelectDateWidget extends StatelessWidget {
  const CreateMonthlyPlanSelectDateWidget({super.key});
    ...
    return   BlocBuilder<CreateMonthlyPlanCubit, CreateMonthlyPlanState>(
      ...
      builder: (context, state) {
        return GestureDetector(
          onTap: () {
            CreateMonthlyPlanCubit.get(context).selectDate(context);
          },
          child: Container(
            padding:
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                      _formatDate(CreateMonthlyPlanCubit.get(context)
                          .selectedDate),
                      maxLines: 1,
