...
class AddCustomerCommercialHistoryWidget extends StatelessWidget {
  const AddCustomerCommercialHistoryWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return AppTextFormField(
      hintText: "السحل التجاري",
      maxLines: 1,
      hintStyle: TextStyles.font14GreyColor87Weight400,
      textStyle: TextStyles.font14BlackColorWeight400,
      controller: AddCustomerCubit.get(context).commercialNumberController,
      backgroundColor: AppColors.whiteColor,
      prefixIcon: Padding(
        padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
        child: SvgPicture.asset(ImageAsset.icon4),
      ),
