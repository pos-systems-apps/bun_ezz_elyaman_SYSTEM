...
class AddCustomerCountryWidget extends StatelessWidget {
  const AddCustomerCountryWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddCustomerCubit.get(context).countryController,
      backgroundColor: AppColors.whiteColor,
      prefixIcon: Padding(
        padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
        child: SvgPicture.asset(ImageAsset.icon8),
      ),
