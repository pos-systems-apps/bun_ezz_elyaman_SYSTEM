...
class AddCustomerTaxNumberWidget extends StatelessWidget {
  const AddCustomerTaxNumberWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddCustomerCubit.get(context).numberTaxController,
      backgroundColor: AppColors.whiteColor,
      prefixIcon: Padding(
        padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
        child: SvgPicture.asset(ImageAsset.icon3),
      ),
