...
class AddCustomerClassificationWidget extends StatelessWidget {
  const AddCustomerClassificationWidget({super.key});
    ...
    return BlocBuilder<AddCustomerCubit, AddCustomersState>(
      ...
      builder: (context, state) {
        return AppDropDownField(
            hintText: AddCustomerCubit.get(context).selectedCategory?.name?? "التصنيف",
            hintStyle: TextStyles.font14GreyColor87Weight400,
            textStyle: TextStyles.font14BlackColorWeight400,
            items: AddCustomerCubit.get(context).categories,
            ...
            onChanged: (dynamic value) {
              AddCustomerCubit.get(context).changeSelectedCategory(value);
            });
      },
    );
  }
