...
class AddCustomerEmailWidget extends StatelessWidget {
  const AddCustomerEmailWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddCustomerCubit.get(context).emailController,
      backgroundColor: AppColors.whiteColor,
      prefixIcon: Padding(
        padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 10.h),
        child: SvgPicture.asset(ImageAsset.icon6),
      ),
