...
class AddMyRequestNotesTextFieldWidget extends StatelessWidget {
  const AddMyRequestNotesTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddMyRequestCubit.get(context).notesController,
