...
class AddLeaveRequestNotesTextFieldWidget extends StatelessWidget {
  const AddLeaveRequestNotesTextFieldWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: AddLeaveRequestCubit.get(context).notesController,
