...
class AddLeaveRequestSelectDate2Widget extends StatelessWidget {
  const AddLeaveRequestSelectDate2Widget({super.key});
    ...
    return BlocBuilder<AddLeaveRequestCubit, AddLeaveRequestState>(
      ...
      builder: (context, state) {
        return GestureDetector(
          onTap: () {
            AddLeaveRequestCubit.get(context).selectDate1(context);
          },
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                      _formatDate(
                          AddLeaveRequestCubit.get(context).selectedDate1),
                      maxLines: 1,
